...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\GitHub\FPGA\FPGA_SoC\synthesis\FPGA_SoC.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\GitHub\FPGA\FPGA_SoC\constraint\io\FPGA_SoC.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\GitHub\FPGA\FPGA_SoC\constraint\fp\FPGA_SoC.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M1000 \
    -pkg vf256 \
    -pdc_file {D:\GitHub\FPGA\FPGA_SoC\constraint\io\FPGA_SoC.io.pdc} \
    -pdc_file {D:\GitHub\FPGA\FPGA_SoC\constraint\fp\FPGA_SoC.fp.pdc} \
    -merge_pdc 0
