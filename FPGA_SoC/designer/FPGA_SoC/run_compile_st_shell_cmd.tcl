...
save
set has_violations {D:\GitHub\FPGA\FPGA_SoC\designer\FPGA_SoC\FPGA_SoC_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {D:\GitHub\FPGA\FPGA_SoC\designer\FPGA_SoC\FPGA_SoC_combinational_loops.xml}
if { [catch "file delete -force -- {D:\GitHub\FPGA\FPGA_SoC\designer\FPGA_SoC\pinslacks.txt}"] } {
   ;
}
report -type slack {D:\GitHub\FPGA\FPGA_SoC\designer\FPGA_SoC\pinslacks.txt}
